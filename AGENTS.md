...
> Configure via `/meta-skill-creator` — do not invoke directly.

| Skill | Triggers on |
|-------|-------------|
| `connector-salesforce` | Salesforce, CRM, account data, pipeline — configure personal connector |
| `connector-m365-docs` | SharePoint, OneDrive, contracts, project docs — configure personal connector |
| `connector-m365-email` | Outlook, email threads, meeting prep — configure personal connector |
| `connector-excel` | Excel, pricing sheets, BOM, rate card — configure personal connector |
...
| `connector-m365-docs` | — | — | — | — | — | `## connector-m365-docs` |
| `connector-m365-email` | — | — | — | — | — | `## connector-m365-email` |
| `connector-excel` | — | — | — | — | — | `## connector-excel` |
